    ...
    public class DuplexNodeEndpointTest
    {
        ...
        public void TestDuplexNodeEndpoint()
        {
            ...
            Thread serverThread = new Thread(() =>
            {
                ...
                server = listener.WaitForServer("DuplexService", new DuplexServer());
            });
            serverThread.Start();

            client = factory.WaitForClient<IDuplexServer, DuplexCallback>("localhost/DuplexService", "DuplexServer", new DuplexCallback());

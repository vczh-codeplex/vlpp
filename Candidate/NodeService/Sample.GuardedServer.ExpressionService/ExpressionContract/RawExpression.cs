...
namespace FvCalculation
{
    ...
    [NodeEndpointKnownType(typeof(FunctionExpression))]
    [NodeEndpointKnownType(typeof(NumberExpression))]
    [NodeEndpointKnownType(typeof(VariableExpression))]
    [NodeEndpointKnownType(typeof(AddExpression))]
    [NodeEndpointKnownType(typeof(SubExpression))]
    [NodeEndpointKnownType(typeof(MulExpression))]
    [NodeEndpointKnownType(typeof(DivExpression))]
    [NodeEndpointKnownType(typeof(PowerExpression))]
    [NodeEndpointKnownType(typeof(NegExpression))]
    ...
    [NodeEndpointDataType]
    [NodeEndpointKnownType(typeof(ExpExpression))]
    [NodeEndpointKnownType(typeof(LnExpression))]
    [NodeEndpointKnownType(typeof(SinExpression))]
    [NodeEndpointKnownType(typeof(CosExpression))]
    [NodeEndpointKnownType(typeof(TanExpression))]
    [NodeEndpointKnownType(typeof(CotExpression))]
    [NodeEndpointKnownType(typeof(SecExpression))]
    [NodeEndpointKnownType(typeof(CscExpression))]

	...
	namespace scripting
	{
		namespace managedlanguage
		{
			...
			public:
				...
				static WString InterfaceIllegalMemberType(const WString& name, const WString& member);
				static WString InterfaceIllegalMemberAccessor(const WString& name, const WString& member);
				static WString InterfaceIllegalMemberMemberType(const WString& name, const WString& member);
				static WString InterfaceIllegalMemberInheritation(const WString& name, const WString& member);

...
namespace vl
{
	namespace scripting
	{
		namespace managedlanguage
		{
			...
			extern bool									ManagedLanguage_ImportSymbols(Ptr<ResourceStream> resourceStream, ManagedSymbolManager* symbolManager, const WString& assemblyName, bool includingInternal, collections::List<ResourceHandle<ManagedSymbolItemRes>>& unresolvedTypes);
		}
	}
}

...
namespace vl
{
	namespace scripting
	{
		namespace basiclanguage
		{
			...
			DEFINE_ALGORITHM_ACCEPT_IMPLEMENTATION(BasicExpression, BASIC_EXPRESSION_TARGETS)
			DEFINE_ALGORITHM_ACCEPT_IMPLEMENTATION(BasicStatement, BASIC_STATEMENT_TARGETS)
			DEFINE_ALGORITHM_ACCEPT_IMPLEMENTATION(BasicType, BASIC_TYPE_TARGETS)
			DEFINE_ALGORITHM_ACCEPT_IMPLEMENTATION(BasicDeclaration, BASIC_DECLARATION_TARGETS)

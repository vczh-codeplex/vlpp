namespace Test.Host.LanguageForms.NativeX
{
    partial class NativeXForm
    {
        ...
        {
            Developer.WinFormControls.TextEditorControlPanel textEditorControlPanel2 = new Developer.WinFormControls.TextEditorControlPanel();
            ...
            this.textEditorBox.ControlPanel = textEditorControlPanel2;
            ...
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.NativeXForm_FormClosed);
            this.Shown += new System.EventHandler(this.NativeXForm_Shown);

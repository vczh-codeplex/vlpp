...
namespace Developer.LanguageServices.NativeX
{
    public static partial class NativeXCodeParser
    {
            ...
            Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration> DeclarationsMember0 = default(Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration>);
            {
                ...
                int currentIndex1 = currentToken;
                {
                    ...
                    currentIndex2 = currentIndex1;
                    {
                        ...
                        Developer.LanguageProvider.CodeTokenizer.ParseToken(tokens, ref currentIndex3, ref parseSuccess, "unit");
                        ...
                        }
                        {
                            ...
                            result4 = Developer.LanguageProvider.CodeTokenizer.ParseToken(tokens, ref currentIndex4, ref parseSuccess, Developer.LanguageServices.NativeX.NativeXTokenizer.IdToken);
                            if (parseSuccess || forceSuccess1)
                            {
                                currentIndex3 = currentIndex4;
                                NameMember0 = result4.Value;
                            }
                        }
                        if (parseSuccess || forceSuccess1)
                        {
                    ...
                    {
                        NameMember0 = default(System.String);
                    }
                    parseSuccess = true;
                }
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration ParseNonGenericDeclaration(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            ...
            Developer.LanguageProvider.TextPosition start = Developer.LanguageProvider.CodeTokenizer.GetStartPosition(tokens, currentToken);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration);
            Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXAttribute> AttributesMember0 = default(Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXAttribute>);
            {
                Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration result1 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration);
                int currentIndexCopy1 = currentToken;
                int currentIndex1 = currentToken;
                {
                    Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXAttribute> result2 = default(Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXAttribute>);
                    int currentIndex2 = currentIndex1;
                    result2 = new Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXAttribute>();
                    {
                        Developer.LanguageServices.NativeX.SyntaxTree.NativeXAttribute result3 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXAttribute);
                        int currentIndex3 = currentIndex2;
                        bool forceSuccess1 = false;
                        parseSuccess = false;
                        result3 = ParseAttribute(tokens, ref currentIndex3, ref parseSuccess);
                        if (parseSuccess || forceSuccess1)
                        {
                            currentIndex2 = currentIndex3;
                            result2.Add(result3);
                ...
                }
                {
                    ...
                    int currentIndex2 = currentIndex1;
                    parseSuccess = false;
                    result2 = ParseDeclarationCandidate(tokens, ref currentIndex2, ref parseSuccess);
                    if (parseSuccess || forceSuccess0)
                    {
                        currentIndex1 = currentIndex2;
                        result1 = result2;
            ...
            {
                if (result == null) result = CodeNode.Create<Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration>();
                result.Attributes = AttributesMember0;
                result.Start = start;
                result.End = Developer.LanguageProvider.CodeTokenizer.GetEndPosition(tokens, currentToken);
                parseSuccess = true;
            }
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXAttribute ParseAttribute(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            bool forceSuccess0 = false;
            Developer.LanguageProvider.TextPosition start = Developer.LanguageProvider.CodeTokenizer.GetStartPosition(tokens, currentToken);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXAttribute result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXAttribute);
            System.String NameMember0 = default(System.String);
            {
                Developer.LanguageProvider.CodeToken result1 = default(Developer.LanguageProvider.CodeToken);
                int currentIndex1 = currentToken;
                result1 = Developer.LanguageProvider.CodeTokenizer.ParseToken(tokens, ref currentIndex1, ref parseSuccess, Developer.LanguageServices.NativeX.NativeXTokenizer.AttributeToken);
                if (parseSuccess || forceSuccess0)
                {
                    currentToken = currentIndex1;
                    NameMember0 = result1.Value;
                }
            }
            if (parseSuccess || forceSuccess0)
            {
                if (result == null) result = CodeNode.Create<Developer.LanguageServices.NativeX.SyntaxTree.NativeXAttribute>();
                result.Name = NameMember0;
                result.Start = start;
                result.End = Developer.LanguageProvider.CodeTokenizer.GetEndPosition(tokens, currentToken);
                parseSuccess = true;
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration ParseDeclarationCandidate(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            bool forceSuccess0 = false;
            Developer.LanguageProvider.TextPosition start = Developer.LanguageProvider.CodeTokenizer.GetStartPosition(tokens, currentToken);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration);
            ...
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXStatement StatementMember0 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXStatement);
            {
                ...
                }
                {
                    ...
                    result2 = new Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXNameTypePair>();
                    {
                        ...
                        bool forceSuccess1 = false;
                        parseSuccess = false;
                        result3 = ParseFunctionParameterItem(tokens, ref currentIndex3, ref parseSuccess);
                        if (parseSuccess || forceSuccess1)
                        {
                            currentIndex2 = currentIndex3;
                            result2.Add(result3);
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXType ParsePrimitiveType(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            ...
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXType result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXType);
            {
                ...
                currentIndex1 = currentToken;
                {
                    Developer.LanguageServices.NativeX.SyntaxTree.NativeXTypeofMemberType result2 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXTypeofMemberType);
                    int currentIndex2 = currentIndex1;
                    parseSuccess = false;
                    result2 = ParseTypeofMember(tokens, ref currentIndex2, ref parseSuccess);
                    if (parseSuccess || forceSuccess1)
                    {
                        currentIndex1 = currentIndex2;
                        result1 = result2;
                ...
                currentIndex1 = currentToken;
                {
                    Developer.LanguageServices.NativeX.SyntaxTree.NativeXTypeofExpressionType result2 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXTypeofExpressionType);
                    int currentIndex2 = currentIndex1;
                    parseSuccess = false;
                    result2 = ParseTypeofExpression(tokens, ref currentIndex2, ref parseSuccess);
                    if (parseSuccess || forceSuccess1)
                    {
                        currentIndex1 = currentIndex2;
                        result1 = result2;
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXTypeofMemberType ParseTypeofMember(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            bool forceSuccess0 = false;
            Developer.LanguageProvider.TextPosition start = Developer.LanguageProvider.CodeTokenizer.GetStartPosition(tokens, currentToken);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXTypeofMemberType result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXTypeofMemberType);
            ...
            System.String MemberNameMember0 = default(System.String);
            {
                int currentIndexCopy1 = currentToken;
                int currentIndex1 = currentToken;
                Developer.LanguageProvider.CodeTokenizer.ParseToken(tokens, ref currentIndex1, ref parseSuccess, "typeof");
                if (parseSuccess || forceSuccess0)
                {
                    currentIndexCopy1 = currentIndex1;
                }
                ...
                }
                {
                    ...
                    {
                        currentIndex1 = currentIndex2;
                        MemberNameMember0 = result2.Value;
                    }
                }
                if (parseSuccess || forceSuccess0)
                {
            ...
            if (parseSuccess || forceSuccess0)
            {
                if (result == null) result = CodeNode.Create<Developer.LanguageServices.NativeX.SyntaxTree.NativeXTypeofMemberType>();
                result.Type = TypeMember0;
                result.MemberName = MemberNameMember0;
                result.Start = start;
                result.End = Developer.LanguageProvider.CodeTokenizer.GetEndPosition(tokens, currentToken);
                parseSuccess = true;
            }
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXTypeofExpressionType ParseTypeofExpression(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            bool forceSuccess0 = false;
            Developer.LanguageProvider.TextPosition start = Developer.LanguageProvider.CodeTokenizer.GetStartPosition(tokens, currentToken);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXTypeofExpressionType result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXTypeofExpressionType);
            ...
            if (parseSuccess || forceSuccess0)
            {
                if (result == null) result = CodeNode.Create<Developer.LanguageServices.NativeX.SyntaxTree.NativeXTypeofExpressionType>();
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXExpression ParseEXP0(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            ...
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXExpression result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXExpression);
            {
                ...
                currentIndex1 = currentToken;
                {
                    Developer.LanguageServices.NativeX.SyntaxTree.NativeXSizeofTypeExpression result2 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXSizeofTypeExpression);
                    int currentIndex2 = currentIndex1;
                    parseSuccess = false;
                    result2 = ParseSizeofType(tokens, ref currentIndex2, ref parseSuccess);
                    if (parseSuccess || forceSuccess1)
                    {
                        currentIndex1 = currentIndex2;
                        result1 = result2;
                ...
                currentIndex1 = currentToken;
                {
                    Developer.LanguageServices.NativeX.SyntaxTree.NativeXOffsetofMemberExpression result2 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXOffsetofMemberExpression);
                    int currentIndex2 = currentIndex1;
                    parseSuccess = false;
                    result2 = ParseOffsetofMember(tokens, ref currentIndex2, ref parseSuccess);
                    if (parseSuccess || forceSuccess1)
                    {
                        currentIndex1 = currentIndex2;
                        result1 = result2;
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXSizeofTypeExpression ParseSizeofType(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            bool forceSuccess0 = false;
            Developer.LanguageProvider.TextPosition start = Developer.LanguageProvider.CodeTokenizer.GetStartPosition(tokens, currentToken);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXSizeofTypeExpression result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXSizeofTypeExpression);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXType TypeMember0 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXType);
            {
                int currentIndexCopy1 = currentToken;
                int currentIndex1 = currentToken;
                Developer.LanguageProvider.CodeTokenizer.ParseToken(tokens, ref currentIndex1, ref parseSuccess, "sizeof");
                if (parseSuccess) forceSuccess0 = true;
                if (parseSuccess || forceSuccess0)
                {
                    currentIndexCopy1 = currentIndex1;
            ...
            if (parseSuccess || forceSuccess0)
            {
                if (result == null) result = CodeNode.Create<Developer.LanguageServices.NativeX.SyntaxTree.NativeXSizeofTypeExpression>();
                result.Type = TypeMember0;
                result.Start = start;
                result.End = Developer.LanguageProvider.CodeTokenizer.GetEndPosition(tokens, currentToken);
                parseSuccess = true;
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXOffsetofMemberExpression ParseOffsetofMember(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            bool forceSuccess0 = false;
            Developer.LanguageProvider.TextPosition start = Developer.LanguageProvider.CodeTokenizer.GetStartPosition(tokens, currentToken);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXOffsetofMemberExpression result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXOffsetofMemberExpression);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXType TypeMember0 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXType);
            System.String MemberNameMember0 = default(System.String);
            {
                int currentIndexCopy1 = currentToken;
                int currentIndex1 = currentToken;
                Developer.LanguageProvider.CodeTokenizer.ParseToken(tokens, ref currentIndex1, ref parseSuccess, "offsetof");
                if (parseSuccess) forceSuccess0 = true;
                if (parseSuccess || forceSuccess0)
                {
                    currentIndexCopy1 = currentIndex1;
            ...
            if (parseSuccess || forceSuccess0)
            {
                if (result == null) result = CodeNode.Create<Developer.LanguageServices.NativeX.SyntaxTree.NativeXOffsetofMemberExpression>();
                result.Type = TypeMember0;
                result.MemberName = MemberNameMember0;
                result.Start = start;
                result.End = Developer.LanguageProvider.CodeTokenizer.GetEndPosition(tokens, currentToken);
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXNameTypePair ParseFunctionParameterItem(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            bool forceSuccess0 = false;
            Developer.LanguageProvider.TextPosition start = Developer.LanguageProvider.CodeTokenizer.GetStartPosition(tokens, currentToken);
                    ...
                    currentIndex2 = currentIndex1;
                    {
                        ...
                        }
                        {
                            ...
                            result4 = new Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXNameTypePair>();
                            {
                                ...
                                bool forceSuccess2 = false;
                                parseSuccess = false;
                                result5 = ParseStructureMemberItem(tokens, ref currentIndex5, ref parseSuccess);
                                if (parseSuccess || forceSuccess2)
                                {
                                    currentIndex4 = currentIndex5;
                                    result4.Add(result5);
                    ...
                    currentIndex2 = currentIndex1;
                    {
                        ...
                        }
                        {
                            ...
                            result4 = new Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXNameExpressionPair>();
                            {
                                ...
                                bool forceSuccess2 = false;
                                parseSuccess = false;
                                result5 = ParseInstanceFunctionItem(tokens, ref currentIndex5, ref parseSuccess);
                                if (parseSuccess || forceSuccess2)
                                {
                                    currentIndex4 = currentIndex5;
                                    result4.Add(result5);
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXNameExpressionPair ParseInstanceFunctionItem(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            ...
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXExpression ExpressionMember0 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXExpression);
            {
                ...
                }
                {
                    ...
                    int currentIndex2 = currentIndex1;
                    parseSuccess = false;
                    result2 = ParseStrictReference(tokens, ref currentIndex2, ref parseSuccess);
                    if (parseSuccess || forceSuccess0)
                    {
                        currentIndex1 = currentIndex2;
                        ExpressionMember0 = result2;
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXExpression ParseStrictReference(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            bool forceSuccess0 = false;
            Developer.LanguageProvider.TextPosition start = Developer.LanguageProvider.CodeTokenizer.GetStartPosition(tokens, currentToken);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXExpression result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXExpression);
            {
                ...
                currentIndex1 = currentToken;
                {
                    ...
                    int currentIndex2 = currentIndex1;
                    parseSuccess = false;
                    result2 = ParseStrictInstanceFunctionReference(tokens, ref currentIndex2, ref parseSuccess);
                    if (parseSuccess || forceSuccess1)
                    {
                        currentIndex1 = currentIndex2;
                        result1 = result2;
                ...
                currentIndex1 = currentToken;
                {
                    ...
                    int currentIndex2 = currentIndex1;
                    parseSuccess = false;
                    result2 = ParseStrictInstanciatedReference(tokens, ref currentIndex2, ref parseSuccess);
                    if (parseSuccess || forceSuccess1)
                    {
                        currentIndex1 = currentIndex2;
                        result1 = result2;
                ...
                currentIndex1 = currentToken;
                {
                    ...
                    int currentIndex2 = currentIndex1;
                    parseSuccess = false;
                    result2 = ParseStrictIdentifierReference(tokens, ref currentIndex2, ref parseSuccess);
                    if (parseSuccess || forceSuccess1)
                    {
                        currentIndex1 = currentIndex2;
                        result1 = result2;
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXInstanceFunctionExpression ParseStrictInstanceFunctionReference(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            bool forceSuccess0 = false;
            Developer.LanguageProvider.TextPosition start = Developer.LanguageProvider.CodeTokenizer.GetStartPosition(tokens, currentToken);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXInstanceFunctionExpression result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXInstanceFunctionExpression);
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXInstanciatedExpression ParseStrictInstanciatedReference(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            bool forceSuccess0 = false;
            Developer.LanguageProvider.TextPosition start = Developer.LanguageProvider.CodeTokenizer.GetStartPosition(tokens, currentToken);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXInstanciatedExpression result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXInstanciatedExpression);
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXReferenceExpression ParseStrictIdentifierReference(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            bool forceSuccess0 = false;
            Developer.LanguageProvider.TextPosition start = Developer.LanguageProvider.CodeTokenizer.GetStartPosition(tokens, currentToken);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXReferenceExpression result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXReferenceExpression);
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXConceptDeclaration ParseConceptDeclaration(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            ...
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXGenericParameter ConceptTypeMember0 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXGenericParameter);
            System.String NameMember0 = default(System.String);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXLinking LinkingMember0 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXLinking);
            Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXNameTypePair> FunctionsMember0 = default(Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXNameTypePair>);
            {
                ...
                {
                    Developer.LanguageServices.NativeX.SyntaxTree.NativeXGenericParameter result2 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXGenericParameter);
                    int currentIndex2 = currentIndex1;
                    parseSuccess = false;
                    result2 = ParseGenericParameterItem(tokens, ref currentIndex2, ref parseSuccess);
                    if (parseSuccess || forceSuccess0)
                    {
                        currentIndex1 = currentIndex2;
                        ConceptTypeMember0 = result2;
                    }
                }
                if (parseSuccess || forceSuccess0)
                {
                ...
                }
                {
                    ...
                    result2 = new Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXNameTypePair>();
                    {
                        ...
                        bool forceSuccess1 = false;
                        parseSuccess = false;
                        result3 = ParseConceptFunctionItem(tokens, ref currentIndex3, ref parseSuccess);
                        if (parseSuccess || forceSuccess1)
                        {
                            currentIndex2 = currentIndex3;
                            result2.Add(result3);
        ...
        public static Developer.LanguageServices.NativeX.SyntaxTree.NativeXEditingDeclarations ParseEditingDeclarations(List<CodeToken> tokens, ref int currentToken, ref bool parseSuccess)
        {
            bool forceSuccess0 = false;
            Developer.LanguageProvider.TextPosition start = Developer.LanguageProvider.CodeTokenizer.GetStartPosition(tokens, currentToken);
            Developer.LanguageServices.NativeX.SyntaxTree.NativeXEditingDeclarations result = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXEditingDeclarations);
            Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration> DeclarationsMember0 = default(Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration>);
            {
                Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration> result1 = default(Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration>);
                int currentIndex1 = currentToken;
                result1 = new Developer.LanguageProvider.CodeNodeList<Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration>();
                {
                    Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration result2 = default(Developer.LanguageServices.NativeX.SyntaxTree.NativeXDeclaration);
                    int currentIndex2 = currentIndex1;
                    bool forceSuccess1 = false;
                    parseSuccess = false;
                    result2 = ParseDeclaration(tokens, ref currentIndex2, ref parseSuccess);
                    if (parseSuccess || forceSuccess1)
                    {
                        currentIndex1 = currentIndex2;
                        result1.Add(result2);
                ...
                {
                    currentToken = currentIndex1;
                    DeclarationsMember0 = result1;
                }
            }
            if (parseSuccess || forceSuccess0)
            {
                if (result == null) result = CodeNode.Create<Developer.LanguageServices.NativeX.SyntaxTree.NativeXEditingDeclarations>();
                result.Declarations = DeclarationsMember0;
                result.Start = start;
                result.End = Developer.LanguageProvider.CodeTokenizer.GetEndPosition(tokens, currentToken);
                parseSuccess = true;
